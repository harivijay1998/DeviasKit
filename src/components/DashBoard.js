...
const Dashboard = () => {
  ...
  const products = [
    { name: 'Soja & Co. Eucalyptus', date: 'Updated Mar 8, 2024', img: 'images/product-5.png' },
    { name: 'Necessaire Body Lotion', date: 'Updated Mar 8, 2024', img: 'images/product-5.png' },
    { name: 'Necessaire Body Lotion', date: 'Updated Mar 8, 2024', img: 'images/product-5.png' },
    { name: 'Necessaire Body Lotion', date: 'Updated Mar 8, 2024', img: 'images/product-5.png' },
  ...
  return (
    <>
      ...
      <Box sx={{ p: 4, backgroundColor: '#f5f5f5', minHeight: '100vh' , marginTop:'100px'}}>
...
/>
                ...
                >
                  <span style={{ color: item.percentage < 15 ? 'green':  'red' }}>
                    {item.trend} 
                  </span>
                  <span style={{ color: item.percentage < 15 ? 'green' : 'red', marginLeft: '8px' }}>
                    {item.percentage}%
                  </span>
                  <span style={{fontSize:'12px' , marginInlineStart:'15px'}}>{item.description}</span> 
                </Typography>
                )}
              </Box>
              <Box
